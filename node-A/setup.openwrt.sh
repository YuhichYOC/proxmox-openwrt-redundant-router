...
SETUP_OPENWRT_NET_WAN="virtio=02:50:58:00:00:01,bridge=br0_wan"
# 引数 : OpenWrt VM が VRRP で利用する NIC の MAC アドレスと接続する仮想ブリッジの名前
SETUP_OPENWRT_NET_VRRP="virtio=02:50:58:00:04:01,bridge=br4_vrrp"
# 引数 : OpenWrt VM がインターネットアクセス提供用に使用する NIC の MAC アドレスと接続する仮想ブリッジの名前
SETUP_OPENWRT_NET_INET="virtio=02:50:58:00:05:01,bridge=br5_inet"
